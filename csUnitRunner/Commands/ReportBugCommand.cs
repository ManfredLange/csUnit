...
namespace csUnit.Runner.Commands {
   /// <summary>
   /// Summary description for ReportBugCommand.
   /// </summary>
   public class ReportBugCommand : Command {

      private const int _menuPosition = 5;
      ...
      protected override void Execute(object sender, EventArgs args) {
         try {
            System.Diagnostics.Process.Start(REPORT_BUG_URL);
         }
         catch(Exception) {
      ...
      private const string REPORT_BUG_URL = @"http://sourceforge.net/tracker/?group_id=23919&atid=380010";
   }
}
