...
namespace csUnit.Core.Criteria {
   /// <summary>
   /// A test selection criteria based solely on the name of a method.
   /// </summary>
   [Serializable]
   public class NameCriterion : ICriterion {
      public NameCriterion(string methodFullName) {
         _methodFullName = methodFullName;
      }

      public bool Contains(ITestMethod testMethod) {
         return testMethod.FullName.Equals(_methodFullName );
      }
